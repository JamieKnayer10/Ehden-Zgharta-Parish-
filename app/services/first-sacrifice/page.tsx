...
import { ArrowLeft, Baby, CheckCircle, Send } from "lucide-react"

export default function FirstSacrificePage() {
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <Input id="fatherName" placeholder="Father's full name" required />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="motherName">{"Mother's"} Triple Name *</Label>
                          <Input id="motherName" placeholder="Mother's maiden name (triple)" required />
                        </div>
                      </div>
                      ...
                      <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input id="birthPlace" placeholder="City, Country" required />
                        </div>
                      </div>

                      <div className="space-y-2">
                        <Label htmlFor="baptismChurch">Baptism Church *</Label>
                        <Input id="baptismChurch" placeholder="Name of church where baptized" required />
                      </div>

                      <div className="space-y-2">
                        <Label htmlFor="baptismDate">Date of Baptism *</Label>
                        <Input id="baptismDate" type="date" required />
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select required>
                          ...
                          <SelectContent>
                            <SelectItem value="ehden">Ehden Parish</SelectItem>
                            <SelectItem value="zgharta">Zgharta Parish</SelectItem>
