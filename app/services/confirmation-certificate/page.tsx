...
import { ArrowLeft, Award, CheckCircle, Send } from "lucide-react"
              ...
              <Card className="border-none shadow-xl">
                <CardHeader className="border-b bg-muted/50">
                  <CardTitle className="flex items-center gap-2">
                    ...
                    Confirmation Certificate Request
                  </CardTitle>
                </CardHeader>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <Input id="confirmationDate" type="date" required />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="confirmationChurch">Church of Confirmation *</Label>
                          <Select required>
                            <SelectTrigger>
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="godparent">Godparent Name</Label>
                        <Input id="godparent" placeholder="Name of godparent (if known)" />
                      </div>
                    </div>
