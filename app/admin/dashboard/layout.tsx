...
const SEARCH_ITEMS = [
  ...
  { label: "Yanabi3 Bulletins", href: "/admin/dashboard/yanabi3" },
  { label: "Home Page", href: "/admin/dashboard/pages/home" },
  { label: "About", href: "/admin/dashboard/pages/about" },
  { label: "History", href: "/admin/dashboard/pages/history" },
  { label: "The Vicar", href: "/admin/dashboard/pages/vicar" },
  { label: "Patriarch Douaihy", href: "/admin/dashboard/pages/patriarch" },
  { label: "Services", href: "/admin/dashboard/pages/services" },
  { label: "Media Center", href: "/admin/dashboard/pages/media" },
  { label: "Radio Ehden", href: "/admin/dashboard/pages/radio" },
  { label: "Zgharta Channel", href: "/admin/dashboard/pages/channel" },
  { label: "Contact", href: "/admin/dashboard/pages/contact" },
...
const ROUTE_LABELS: Record<string, string> = {
  ...
  "/admin/dashboard/yanabi3":          "Yanabi3 Bulletins",
  "/admin/dashboard/settings":         "Settings",
  "/admin/dashboard/pages/home":       "Home Page",
  "/admin/dashboard/pages/about":      "About",
  "/admin/dashboard/pages/history":    "History",
  "/admin/dashboard/pages/vicar":      "The Vicar",
  "/admin/dashboard/pages/patriarch":  "Patriarch Douaihy",
  "/admin/dashboard/pages/services":   "Services",
  "/admin/dashboard/pages/media":      "Media Center",
  "/admin/dashboard/pages/radio":      "Radio Ehden",
  "/admin/dashboard/pages/channel":    "Zgharta Channel",
  "/admin/dashboard/pages/contact":    "Contact",
}
