...
export function NewsListClient({ articles }: { articles: NewsListItem[] }) {
      ...
      <main className="flex-1">
        <section className="relative bg-primary py-20">
          ...
          <div className="relative mx-auto max-w-7xl px-4 lg:px-8 text-center text-primary-foreground">
            ...
            <p
              className="mt-4 text-2xl font-light text-secondary text-center"
              dir="rtl"
            >
              أخبار الرعية
            </p>
            <p className="mt-4 text-lg text-primary-foreground/80 max-w-2xl mx-auto">
              Stay updated with the latest news, announcements, and events from
            ...
            <div className="mx-auto max-w-7xl px-4 lg:px-8">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {featuredArticles.slice(0, 2).map((article) => (
                  <Card
                    key={article.id}
                    className="group overflow-hidden border-none shadow-xl"
                  >
